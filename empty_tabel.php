...
$sql_empty=mysql_query("delete from ".$_GET['tabel']."");
if ($sql_empty)
{
 echo "Proses Empty dari tabel $tabel, berhasil dilakukan ";
 echo "<a href='index.php'>KEMBALI</a>";
}
else{
echo "proses empty tabel $tabel gagal dilakukan";
}
?>
</p>
		...
		<div id="sidebar">
			...
			<ul id="navmenu">
				...
				<li><a href="create_db.php">Create Database</a></li>
				<?php echo "
